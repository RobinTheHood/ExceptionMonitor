<div style="top: 0px; left: 0px; position: fixed; width: 100vw; height: 100vh; background-color: #191C21;">
    <div style="font-size: 14px; background-color: #4576F6; color: white; padding: 10px; font-family: 'BlinkMacSystemFont', 'Lucida Grande', 'Segoe UI', Ubuntu, Cantarell, sans-serif">
        Please wait, ExceptionMonitor is still loading ...
    </div>
